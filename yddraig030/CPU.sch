...
$EndDescr
$Comp
L Ddraig:MC68030 U201
U 1 1 60EB72BE
P 3300 3900
F 0 "U201" H 2550 6800 50  0000 C CNN
F 1 "MC68030" H 4000 6800 50  0000 C CNN
...
A9
$Comp
L Ddraig:MC68881FN U202
U 1 1 60FCAB24
P 8400 4250
F 0 "U202" H 7750 6500 50  0000 C CNN
F 1 "MC68881FN" H 8950 6500 50  0000 C CNN
...
D31
Text HLabel 6850 2550 0    50   BiDi ~ 0
D[0..31]
Wire Bus Line
	7050 2550 6850 2550
$Comp
...
U 1 1 60FD869C
P 3300 750
F 0 "#PWR0202" H 3300 600 50  0001 C CNN
...
U 1 1 60FD90BB
P 8350 1650
F 0 "#PWR0206" H 8350 1500 50  0001 C CNN
...
U 1 1 61078FA3
P 8400 6450
F 0 "#PWR0207" H 8400 6200 50  0001 C CNN
...
U 1 1 61095CC3
P 3250 7450
F 0 "#PWR0201" H 3250 7200 50  0001 C CNN
...
U 1 1 61408B26
P 10300 2300
F 0 "R202" H 10370 2346 50  0000 L CNN
...
U 1 1 61409002
P 10300 2100
F 0 "#PWR0209" H 10300 1950 50  0001 C CNN
...
Wire Wire Line
	9700 3100 9300 3100
Text HLabel 10400 3000 2    50   Input ~ 0
~CS_FPU
Wire Wire Line
...
U 1 1 6147031E
P 9400 3700
F 0 "#PWR0208" H 9400 3550 50  0001 C CNN
F 1 "+5V" H 9415 3873 50  0000 C CNN
...
Wire Wire Line
	2100 3050 2300 3050
Text HLabel 4550 1400 2    50   Output ~ 0
~HALT
...
U 1 1 6144CC5A
P 5250 1200
F 0 "R201" H 5320 1246 50  0000 L CNN
...
U 1 1 614767C1
P 5250 1000
F 0 "#PWR0203" H 5250 850 50  0001 C CNN
...
U 1 1 613B8DE8
P 6950 1750
F 0 "#PWR0205" H 6950 1500 50  0001 C CNN
...
U 1 1 613B8943
P 6950 1050
F 0 "#PWR0204" H 6950 900 50  0001 C CNN
...
U 1 1 613B7690
P 6950 1400
F 0 "X201" H 6607 1446 50  0000 R CNN
F 1 "ACO-xxxMHz" H 6607 1355 50  0000 R CNN
F 2 "Oscillator:Oscillator_DIP-14" H 7400 1050 50  0001 C CNN
F 3 "http://www.conwin.com/datasheets/cx/cx030.pdf" H 6850 1400 50  0001 C CNN
	1    6950 1400
	1    0    0    -1  
$EndComp
Wire Wire Line
