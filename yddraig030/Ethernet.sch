...
Wire Wire Line
	2700 2200 2700 2300
$Comp
L Ddraig:RTL8019AS U601
U 1 1 614ECCC2
P 3400 2800
F 0 "U601" H 2950 4250 35  0000 C CNN
...
U 1 1 614ECCCB
P 2400 2350
F 0 "#PWR0602" H 2400 2200 50  0001 C CNN
...
U 1 1 614ECCD1
P 2400 2850
F 0 "#PWR0603" H 2400 2600 50  0001 C CNN
...
U 1 1 614ECCDE
P 4350 3600
F 0 "R602" H 4420 3646 50  0000 L CNN
...
U 1 1 614ECCE8
P 4350 3900
F 0 "#PWR0608" H 4350 3650 50  0001 C CNN
...
U 1 1 614ECCEE
P 4350 2900
F 0 "#PWR0607" H 4350 2750 50  0001 C CNN
...
Wire Wire Line
	6650 2600 6650 2300
$Comp
L Connector:RJ45_Amphenol_RJMG1BD3B8K1ANR J601
U 1 1 614ECD00
P 8850 3100
F 0 "J601" H 8850 3825 50  0000 C CNN
...
U 1 1 614ECD0C
P 7750 4050
F 0 "C604" H 7865 4096 50  0000 L CNN
...
U 1 1 614ECD12
P 7300 4050
F 0 "C602" H 7415 4096 50  0000 L CNN
...
U 1 1 614ECD1C
P 7550 4400
F 0 "#PWR0611" H 7550 4150 50  0001 C CNN
...
U 1 1 614ECD22
P 8850 3850
F 0 "#PWR0614" H 8850 3600 50  0001 C CNN
...
U 1 1 614ECD28
P 9800 3550
F 0 "#PWR0618" H 9800 3300 50  0001 C CNN
...
U 1 1 614ECD37
P 7850 2100
F 0 "R607" H 7920 2146 50  0000 L CNN
...
U 1 1 614ECD3D
P 7500 2100
F 0 "R606" H 7570 2146 50  0000 L CNN
...
U 1 1 614ECD47
P 3400 1100
F 0 "#PWR0605" H 3400 950 50  0001 C CNN
...
U 1 1 614ECD4D
P 7500 1800
F 0 "#PWR0610" H 7500 1650 50  0001 C CNN
...
U 1 1 614ECD58
P 6050 2550
F 0 "R605" V 5843 2550 50  0000 C CNN
...
U 1 1 614ECD66
P 8650 4850
F 0 "R608" V 8443 4850 50  0000 C CNN
...
U 1 1 614ECD6C
P 8650 5200
F 0 "R609" V 8443 5200 50  0000 C CNN
...
U 1 1 614ECD72
P 8200 4850
F 0 "D601" H 8193 5067 50  0000 C CNN
...
U 1 1 614ECD78
P 8200 5200
F 0 "D602" H 8193 5417 50  0000 C CNN
...
U 1 1 614ECD7E
P 8950 4750
F 0 "#PWR0615" H 8950 4600 50  0001 C CNN
...
U 1 1 614ECD97
P 4500 5250
F 0 "R603" H 4570 5296 50  0000 L CNN
...
U 1 1 614ECD9D
P 4500 5550
F 0 "#PWR0609" H 4500 5300 50  0001 C CNN
...
U 1 1 614ECDA9
P 4950 6550
F 0 "Y601" V 4904 6681 50  0000 L CNN
...
U 1 1 614ECDAF
P 4600 6550
F 0 "R604" H 4670 6596 50  0000 L CNN
...
U 1 1 614ECDC1
P 1900 5400
F 0 "#PWR0601" H 1900 5250 50  0001 C CNN
...
U 1 1 614ECDDC
P 3400 7150
F 0 "#PWR0606" H 3400 6900 50  0001 C CNN
...
U 1 1 614ECE06
P 2550 6800
F 0 "R601" H 2620 6846 50  0000 L CNN
...
U 1 1 614ECE0C
P 2550 7000
F 0 "#PWR0604" H 2550 6750 50  0001 C CNN
...
AR Path="/6139A713/614ECE15" Ref="C603"  Part="1" 
F 0 "C603" H 7815 6346 50  0000 L CNN
...
AR Path="/6139A713/614ECE1B" Ref="C605"  Part="1" 
F 0 "C605" H 8315 6346 50  0000 L CNN
...
AR Path="/6139A713/614ECE21" Ref="C601"  Part="1" 
F 0 "C601" H 7315 6346 50  0000 L CNN
...
AR Path="/6139A713/614ECE27" Ref="#PWR0613"  Part="1" 
F 0 "#PWR0613" H 7700 6400 50  0001 C CNN
...
AR Path="/6139A713/614ECE2D" Ref="#PWR0612"  Part="1" 
F 0 "#PWR0612" H 7700 5800 50  0001 C CNN
...
AR Path="/6139A713/614ECE41" Ref="#PWR0617"  Part="1" 
F 0 "#PWR0617" H 9100 6400 50  0001 C CNN
...
AR Path="/6139A713/614ECE47" Ref="#PWR0616"  Part="1" 
F 0 "#PWR0616" H 9100 5800 50  0001 C CNN
...
U 1 1 614ECE53
P 8800 6300
F 0 "C606" H 8918 6346 50  0000 L CNN
...
U 1 1 614ECE59
P 9400 6300
F 0 "C607" H 9518 6346 50  0000 L CNN
